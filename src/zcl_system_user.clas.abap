class zcl_system_user definition
  public
  final
  create public .
...
class zcl_system_user implementation.

  method zif_system_user~get_businesspartner.
  ...
  method set_businesspartner.
    ...
    if ( sy-subrc ne 0 ) or ( me->mv_businesspartner is initial ).
      ...
      raise exception type zcx_system_user_exc
        exporting
          textid      = zcx_system_user_exc=>bp_not_found_for_user
  ...
  method zif_system_user~get_fullname.
