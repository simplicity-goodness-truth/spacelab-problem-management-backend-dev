...
FORM GET_DATA_ZCRMOAUTOSTATVW.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM ZCRMO_AUTO_STAT WHERE
(VIM_WHERETAB) .
    CLEAR ZCRMOAUTOSTATVW .
ZCRMOAUTOSTATVW-MANDT =
ZCRMO_AUTO_STAT-MANDT .
ZCRMOAUTOSTATVW-PROCESSTYPE =
ZCRMO_AUTO_STAT-PROCESSTYPE .
ZCRMOAUTOSTATVW-STATUSIN =
ZCRMO_AUTO_STAT-STATUSIN .
ZCRMOAUTOSTATVW-STATUSOUT =
ZCRMO_AUTO_STAT-STATUSOUT .
ZCRMOAUTOSTATVW-STAYONSTATUSINHOURS =
ZCRMO_AUTO_STAT-STAYONSTATUSINHOURS .
ZCRMOAUTOSTATVW-STTEXT =
ZCRMO_AUTO_STAT-STTEXT .
ZCRMOAUTOSTATVW-TEXTTYPE =
ZCRMO_AUTO_STAT-TEXTTYPE .
<VIM_TOTAL_STRUC> = ZCRMOAUTOSTATVW.
    APPEND TOTAL.
  ENDSELECT.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZCRMOAUTOSTATVW .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZCRMOAUTOSTATVW.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZCRMOAUTOSTATVW-ST_DELETE EQ GELOESCHT.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM ZCRMO_AUTO_STAT WHERE
  PROCESSTYPE = ZCRMOAUTOSTATVW-PROCESSTYPE AND
  STATUSIN = ZCRMOAUTOSTATVW-STATUSIN .
    IF SY-SUBRC = 0.
    DELETE ZCRMO_AUTO_STAT .
    ENDIF.
...
ZCRMOAUTOSTATVW-TEXTTYPE .
    IF SY-SUBRC = 0.
    UPDATE ZCRMO_AUTO_STAT ##WARN_OK.
    ELSE.
    INSERT ZCRMO_AUTO_STAT .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZCRMOAUTOSTATVW-UPD_FLAG,
STATUS_ZCRMOAUTOSTATVW-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZCRMOAUTOSTATVW.
  SELECT SINGLE * FROM ZCRMO_AUTO_STAT WHERE
PROCESSTYPE = ZCRMOAUTOSTATVW-PROCESSTYPE AND
STATUSIN = ZCRMOAUTOSTATVW-STATUSIN .
ZCRMOAUTOSTATVW-MANDT =
ZCRMO_AUTO_STAT-MANDT .
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZCRMOAUTOSTATVW USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZCRMOAUTOSTATVW-PROCESSTYPE TO
ZCRMO_AUTO_STAT-PROCESSTYPE .
MOVE ZCRMOAUTOSTATVW-STATUSIN TO
ZCRMO_AUTO_STAT-STATUSIN .
MOVE ZCRMOAUTOSTATVW-MANDT TO
ZCRMO_AUTO_STAT-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'ZCRMO_AUTO_STAT'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN ZCRMO_AUTO_STAT TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'ZCRMO_AUTO_STAT'
...
ZCRMOSLAESCALVW-EMAILINWORKINGHOURS =
ZCRMO_SLA_ESCAL-EMAILINWORKINGHOURS .
ZCRMOSLAESCALVW-EMAILNOTIFICATIONSCOUNT =
ZCRMO_SLA_ESCAL-EMAILNOTIFICATIONSCOUNT .
...
FORM GET_DATA_ZSLPMHTTPHDRVW.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM ZSLPM_HTTP_HDR WHERE
(VIM_WHERETAB) .
    CLEAR ZSLPMHTTPHDRVW .
ZSLPMHTTPHDRVW-MANDT =
ZSLPM_HTTP_HDR-MANDT .
ZSLPMHTTPHDRVW-RULEID =
ZSLPM_HTTP_HDR-RULEID .
ZSLPMHTTPHDRVW-TARGET =
ZSLPM_HTTP_HDR-TARGET .
ZSLPMHTTPHDRVW-HEADERKEY =
ZSLPM_HTTP_HDR-HEADERKEY .
ZSLPMHTTPHDRVW-VALUESIGN =
ZSLPM_HTTP_HDR-VALUESIGN .
ZSLPMHTTPHDRVW-VALUEOPTION =
ZSLPM_HTTP_HDR-VALUEOPTION .
ZSLPMHTTPHDRVW-VALUESTRING =
ZSLPM_HTTP_HDR-VALUESTRING .
<VIM_TOTAL_STRUC> = ZSLPMHTTPHDRVW.
    APPEND TOTAL.
  ENDSELECT.
  SORT TOTAL BY <VIM_XTOTAL_KEY>.
  <STATUS>-ALR_SORTED = 'R'.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZSLPMHTTPHDRVW .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZSLPMHTTPHDRVW.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZSLPMHTTPHDRVW-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM ZSLPM_HTTP_HDR WHERE
  RULEID = ZSLPMHTTPHDRVW-RULEID .
    IF SY-SUBRC = 0.
    DELETE ZSLPM_HTTP_HDR .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
      READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY> BINARY SEARCH.
      DELETE EXTRACT INDEX SY-TABIX.
...
ZSLPMHTTPHDRVW-VALUESTRING .
    IF SY-SUBRC = 0.
    UPDATE ZSLPM_HTTP_HDR ##WARN_OK.
    ELSE.
    INSERT ZSLPM_HTTP_HDR .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZSLPMHTTPHDRVW-UPD_FLAG,
STATUS_ZSLPMHTTPHDRVW-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZSLPMHTTPHDRVW.
  SELECT SINGLE * FROM ZSLPM_HTTP_HDR WHERE
RULEID = ZSLPMHTTPHDRVW-RULEID .
ZSLPMHTTPHDRVW-MANDT =
ZSLPM_HTTP_HDR-MANDT .
ZSLPMHTTPHDRVW-RULEID =
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZSLPMHTTPHDRVW USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZSLPMHTTPHDRVW-RULEID TO
ZSLPM_HTTP_HDR-RULEID .
MOVE ZSLPMHTTPHDRVW-MANDT TO
ZSLPM_HTTP_HDR-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'ZSLPM_HTTP_HDR'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN ZSLPM_HTTP_HDR TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'ZSLPM_HTTP_HDR'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
  PERFORM UPDATE_CORR_KEYTAB USING CM_ACTION RETCODE.
  ADD: RETCODE TO RC, 1 TO COUNT.
...
FORM GET_DATA_ZSLPMPRFLDTRSVW.
  PERFORM VIM_FILL_WHERETAB.
*.read data from database.............................................*
  REFRESH TOTAL.
  CLEAR   TOTAL.
  SELECT * FROM ZSLPM_PR_FLD_TRS WHERE
(VIM_WHERETAB) .
    CLEAR ZSLPMPRFLDTRSVW .
ZSLPMPRFLDTRSVW-MANDT =
ZSLPM_PR_FLD_TRS-MANDT .
ZSLPMPRFLDTRSVW-FIELD_NAME =
ZSLPM_PR_FLD_TRS-FIELD_NAME .
ZSLPMPRFLDTRSVW-SPRAS =
ZSLPM_PR_FLD_TRS-SPRAS .
ZSLPMPRFLDTRSVW-TRANSLATION =
ZSLPM_PR_FLD_TRS-TRANSLATION .
<VIM_TOTAL_STRUC> = ZSLPMPRFLDTRSVW.
    APPEND TOTAL.
  ENDSELECT.
  SORT TOTAL BY <VIM_XTOTAL_KEY>.
  <STATUS>-ALR_SORTED = 'R'.
...
ENDFORM.
*---------------------------------------------------------------------*
FORM DB_UPD_ZSLPMPRFLDTRSVW .
*.process data base updates/inserts/deletes.........................*
LOOP AT TOTAL.
  CHECK <ACTION> NE ORIGINAL.
MOVE <VIM_TOTAL_STRUC> TO ZSLPMPRFLDTRSVW.
  IF <ACTION> = UPDATE_GELOESCHT.
    <ACTION> = GELOESCHT.
  ENDIF.
  CASE <ACTION>.
   WHEN NEUER_GELOESCHT.
IF STATUS_ZSLPMPRFLDTRSVW-ST_DELETE EQ GELOESCHT.
     READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
     IF SY-SUBRC EQ 0.
       DELETE EXTRACT INDEX SY-TABIX.
     ENDIF.
    ...
    ENDIF.
   WHEN GELOESCHT.
  SELECT SINGLE FOR UPDATE * FROM ZSLPM_PR_FLD_TRS WHERE
  FIELD_NAME = ZSLPMPRFLDTRSVW-FIELD_NAME AND
  SPRAS = ZSLPMPRFLDTRSVW-SPRAS .
    IF SY-SUBRC = 0.
    DELETE ZSLPM_PR_FLD_TRS .
    ENDIF.
    IF STATUS-DELETE EQ GELOESCHT.
      READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY> BINARY SEARCH.
      DELETE EXTRACT INDEX SY-TABIX.
...
ZSLPMPRFLDTRSVW-TRANSLATION .
    IF SY-SUBRC = 0.
    UPDATE ZSLPM_PR_FLD_TRS ##WARN_OK.
    ELSE.
    INSERT ZSLPM_PR_FLD_TRS .
    ENDIF.
    READ TABLE EXTRACT WITH KEY <VIM_XTOTAL_KEY>.
    IF SY-SUBRC EQ 0.
      <XACT> = ORIGINAL.
  ...
  ENDCASE.
ENDLOOP.
CLEAR: STATUS_ZSLPMPRFLDTRSVW-UPD_FLAG,
STATUS_ZSLPMPRFLDTRSVW-UPD_CHECKD.
MESSAGE S018(SV).
ENDFORM.
*---------------------------------------------------------------------*
FORM READ_SINGLE_ZSLPMPRFLDTRSVW.
  SELECT SINGLE * FROM ZSLPM_PR_FLD_TRS WHERE
FIELD_NAME = ZSLPMPRFLDTRSVW-FIELD_NAME AND
SPRAS = ZSLPMPRFLDTRSVW-SPRAS .
ZSLPMPRFLDTRSVW-MANDT =
ZSLPM_PR_FLD_TRS-MANDT .
...
ENDFORM.
*---------------------------------------------------------------------*
FORM CORR_MAINT_ZSLPMPRFLDTRSVW USING VALUE(CM_ACTION) RC.
  DATA: RETCODE LIKE SY-SUBRC, COUNT TYPE I, TRSP_KEYLEN TYPE SYFLENG.
  FIELD-SYMBOLS: <TAB_KEY_X> TYPE X.
  CLEAR RC.
MOVE ZSLPMPRFLDTRSVW-FIELD_NAME TO
ZSLPM_PR_FLD_TRS-FIELD_NAME .
MOVE ZSLPMPRFLDTRSVW-SPRAS TO
ZSLPM_PR_FLD_TRS-SPRAS .
MOVE ZSLPMPRFLDTRSVW-MANDT TO
ZSLPM_PR_FLD_TRS-MANDT .
  CORR_KEYTAB             =  E071K.
  CORR_KEYTAB-OBJNAME     = 'ZSLPM_PR_FLD_TRS'.
  IF NOT <vim_corr_keyx> IS ASSIGNED.
    ASSIGN CORR_KEYTAB-TABKEY TO <vim_corr_keyx> CASTING.
  ENDIF.
  ASSIGN ZSLPM_PR_FLD_TRS TO <TAB_KEY_X> CASTING.
  PERFORM VIM_GET_TRSPKEYLEN
    USING 'ZSLPM_PR_FLD_TRS'
    CHANGING TRSP_KEYLEN.
  <VIM_CORR_KEYX>(TRSP_KEYLEN) = <TAB_KEY_X>(TRSP_KEYLEN).
  PERFORM UPDATE_CORR_KEYTAB USING CM_ACTION RETCODE.
  ADD: RETCODE TO RC, 1 TO COUNT.
...
ZSLPMPRODATTRVW-PROCESSINGORGUNIT =
ZSLPM_PROD_ATTR-PROCESSINGORGUNIT .
ZSLPMPRODATTRVW-STATUSUPDATESORGUNIT =
ZSLPM_PROD_ATTR-STATUSUPDATESORGUNIT .
ZSLPMPRODATTRVW-STATUSUPDATESSIGNATURE =
ZSLPM_PROD_ATTR-STATUSUPDATESSIGNATURE .
