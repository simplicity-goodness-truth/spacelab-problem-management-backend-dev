class zcl_slpm_odata_request definition
  public
  inheriting from zcl_odata_request
  final
  create public .
  ...
  private section.
    ...
    data :
      mt_http_headers_permissions type table of zslpm_http_hdr,
      mt_http_headers_filter      type zhttp_tt_request_header_filter,
...
class zcl_slpm_odata_request implementation.
  ...
  method zif_slpm_odata_request~is_client_secure.
  ...
  method set_http_headers_permissions.
    ...
    select mandt ruleid target headerkey
        ...
        from zslpm_http_hdr into table mt_http_headers_permissions.

  endmethod.

  method set_http_headers_filter.

    data: wa_http_headers_filter type zhttp_ts_request_header_filter,
  ...
  method is_header_secure.
    ...
    try.
        ...
        if ( me->zif_http_request~is_header_aligned_to_filter( mt_http_headers_filter ) eq abap_false ).
