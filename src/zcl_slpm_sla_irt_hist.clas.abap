class zcl_slpm_sla_irt_hist definition
  public
  final
  create public .
...
class zcl_slpm_sla_irt_hist implementation.
  ...
  method zif_slpm_sla_hist~is_there_pending_shift.

    data: lv_last_out_stat_for_irt_hist type char5,
          lt_statuses_for_irt_recalc    type zslpm_tt_status_pairs.
    ...
    select  statusout
      ...
      try.
          ...
          lt_statuses_for_irt_recalc = new zcl_slpm_irt_recalc_statuses( )->zif_slpm_status_pairs~get_all_status_pairs( ).
  ...
  method zif_slpm_sla_hist~get_last_sla_timestamp.
  ...
  method zif_slpm_sla_hist~get_sla_perc_of_pending_shift.
