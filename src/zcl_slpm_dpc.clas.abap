...
protected section.
  ...
  methods PROCESSORSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PROCESSOR
    raising
  ...
  methods PROCESSORSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PROCESSOR
  ...
  methods PRODUCTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PRODUCT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRODUCTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PRODUCT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods STATUSSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_STATUS
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods STATUSSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_STATUS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SYSTEMUSERSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_SYSTEMUSER
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SYSTEMUSERSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_SYSTEMUSER
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods TEXTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_TEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods TEXTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_TEXT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ATTACHMENTSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_ATTACHMENT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods ATTACHMENTSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_ATTACHMENT
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods COMPANYSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_COMPANY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods COMPANYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_COMPANY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FRONTENDCONFIGUR_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_FRONTENDCONFIGURATION
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FRONTENDCONFIGUR_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_FRONTENDCONFIGURATION
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRIORITYSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PRIORITY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PRIORITYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PRIORITY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PROBLEMSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PROBLEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PROBLEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PROBLEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_SLPM_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 07.04.2023 09:28:53 in client 200
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_SLPM_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA frontendconfigur_create_entity TYPE zcl_slpm_mpc=>ts_frontendconfiguration.
 DATA problemset_create_entity TYPE zcl_slpm_mpc=>ts_problem.
 DATA companyset_create_entity TYPE zcl_slpm_mpc=>ts_company.
 DATA processorset_create_entity TYPE zcl_slpm_mpc=>ts_processor.
 DATA textset_create_entity TYPE zcl_slpm_mpc=>ts_text.
 DATA systemuserset_create_entity TYPE zcl_slpm_mpc=>ts_systemuser.
 DATA statusset_create_entity TYPE zcl_slpm_mpc=>ts_status.
 DATA attachmentset_create_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA priorityset_create_entity TYPE zcl_slpm_mpc=>ts_priority.
 DATA productset_create_entity TYPE zcl_slpm_mpc=>ts_product.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA companyset_get_entity TYPE zcl_slpm_mpc=>ts_company.
 DATA textset_get_entity TYPE zcl_slpm_mpc=>ts_text.
 DATA processorset_get_entity TYPE zcl_slpm_mpc=>ts_processor.
 DATA productset_get_entity TYPE zcl_slpm_mpc=>ts_product.
 DATA frontendconfigur_get_entity TYPE zcl_slpm_mpc=>ts_frontendconfiguration.
 DATA systemuserset_get_entity TYPE zcl_slpm_mpc=>ts_systemuser.
 DATA attachmentset_get_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA statusset_get_entity TYPE zcl_slpm_mpc=>ts_status.
 DATA problemset_get_entity TYPE zcl_slpm_mpc=>ts_problem.
 DATA priorityset_get_entity TYPE zcl_slpm_mpc=>ts_priority.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_SLPM_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA priorityset_get_entityset TYPE zcl_slpm_mpc=>tt_priority.
 DATA problemset_get_entityset TYPE zcl_slpm_mpc=>tt_problem.
 DATA productset_get_entityset TYPE zcl_slpm_mpc=>tt_product.
 DATA companyset_get_entityset TYPE zcl_slpm_mpc=>tt_company.
 DATA statusset_get_entityset TYPE zcl_slpm_mpc=>tt_status.
 DATA textset_get_entityset TYPE zcl_slpm_mpc=>tt_text.
 DATA attachmentset_get_entityset TYPE zcl_slpm_mpc=>tt_attachment.
 DATA systemuserset_get_entityset TYPE zcl_slpm_mpc=>tt_systemuser.
 DATA processorset_get_entityset TYPE zcl_slpm_mpc=>tt_processor.
 DATA frontendconfigur_get_entityset TYPE zcl_slpm_mpc=>tt_frontendconfiguration.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA problemset_update_entity TYPE zcl_slpm_mpc=>ts_problem.
 DATA frontendconfigur_update_entity TYPE zcl_slpm_mpc=>ts_frontendconfiguration.
 DATA productset_update_entity TYPE zcl_slpm_mpc=>ts_product.
 DATA companyset_update_entity TYPE zcl_slpm_mpc=>ts_company.
 DATA processorset_update_entity TYPE zcl_slpm_mpc=>ts_processor.
 DATA textset_update_entity TYPE zcl_slpm_mpc=>ts_text.
 DATA systemuserset_update_entity TYPE zcl_slpm_mpc=>ts_systemuser.
 DATA statusset_update_entity TYPE zcl_slpm_mpc=>ts_status.
 DATA attachmentset_update_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA priorityset_update_entity TYPE zcl_slpm_mpc=>ts_priority.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
