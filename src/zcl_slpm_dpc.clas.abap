...
protected section.
  ...
  methods SLAMPTHISTORYSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_SLAMPTHISTORY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SLAMPTHISTORYSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_SLAMPTHISTORY
  ...
  methods SLAIRTHISTORYSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_SLAIRTHISTORY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SLAIRTHISTORYSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_SLAIRTHISTORY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SYSTEMSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_SYSTEM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SYSTEMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_SYSTEM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods SUPPORTTEAMSET_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_SUPPORTTEAM
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods SUPPORTTEAMSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_SUPPORTTEAM
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FRONTENDCONSTANT_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_FRONTENDCONSTANTS
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods DISPUTEHISTORYSE_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_DISPUTEHISTORY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods DISPUTEHISTORYSE_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_DISPUTEHISTORY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods PROBLEMSET_CREATE_ENTITY
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMHISTORY02_UPDATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PROBLEMHISTORYHIERARCHY
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMHISTORY02_GET_ENTITYSET
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PROBLEMHISTORYHIERARCHY
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMHISTORY02_GET_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMHISTORY02_DELETE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
    ...
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMHISTORY02_CREATE_ENTITY
    importing
      !IV_ENTITY_NAME type STRING
      !IV_ENTITY_SET_NAME type STRING
      !IV_SOURCE_NAME type STRING
  ...
  methods PROBLEMFLOWSTATI_UPDATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_SLPM_MPC=>TS_PROBLEMFLOWSTATISTICS
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  methods PROBLEMFLOWSTATI_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_PROBLEMFLOWSTATISTICS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods FRONTENDCONSTANT_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_SLPM_MPC=>TT_FRONTENDCONSTANTS
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
*&* This class has been generated on 20.11.2023 11:27:40 in client 200
*&*
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA systemset_create_entity TYPE zcl_slpm_mpc=>ts_system.
 DATA productset_create_entity TYPE zcl_slpm_mpc=>ts_product.
 DATA slairthistoryset_create_entity TYPE zcl_slpm_mpc=>ts_slairthistory.
 DATA slampthistoryset_create_entity TYPE zcl_slpm_mpc=>ts_slampthistory.
 DATA attachmentset_create_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA problemhistory02_create_entity TYPE zcl_slpm_mpc=>ts_problemhistoryhierarchy.
 DATA supportteamset_create_entity TYPE zcl_slpm_mpc=>ts_supportteam.
 DATA textset_create_entity TYPE zcl_slpm_mpc=>ts_text.
 DATA frontendconstant_create_entity TYPE zcl_slpm_mpc=>ts_frontendconstants.
 DATA problemflowstati_create_entity TYPE zcl_slpm_mpc=>ts_problemflowstatistics.
 DATA problemset_create_entity TYPE zcl_slpm_mpc=>ts_problem.
 DATA disputehistoryse_create_entity TYPE zcl_slpm_mpc=>ts_disputehistory.
...
*     Call the entity set generated method
    problemhistory02_create_entity(
         EXPORTING iv_entity_name     = iv_entity_name
                   iv_entity_set_name = iv_entity_set_name
                   iv_source_name     = iv_source_name
                   io_data_provider   = io_data_provider
                   ...
                   it_navigation_path = it_navigation_path
                   io_tech_request_context = io_tech_request_context
       	 IMPORTING er_entity          = problemhistory02_create_entity
    ).
*     Send specific entity data to the caller interfaces
    copy_data_to_ref(
      EXPORTING
        is_data = problemhistory02_create_entity
      CHANGING
        cr_data = er_entity
   ).
...
*-------------------------------------------------------------------------*
      when 'ProblemHistoryHierarchySet'.
*     Call the entity set generated method
     problemhistory02_delete_entity(
          EXPORTING iv_entity_name     = iv_entity_name
                    iv_entity_set_name = iv_entity_set_name
                    iv_source_name     = iv_source_name
                    it_key_tab         = it_key_tab
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA disputehistoryse_get_entity TYPE zcl_slpm_mpc=>ts_disputehistory.
 DATA systemuserset_get_entity TYPE zcl_slpm_mpc=>ts_systemuser.
 DATA problemflowstati_get_entity TYPE zcl_slpm_mpc=>ts_problemflowstatistics.
 DATA textset_get_entity TYPE zcl_slpm_mpc=>ts_text.
 DATA frontendconstant_get_entity TYPE zcl_slpm_mpc=>ts_frontendconstants.
 DATA processorset_get_entity TYPE zcl_slpm_mpc=>ts_processor.
 DATA supportteamset_get_entity TYPE zcl_slpm_mpc=>ts_supportteam.
 DATA statusset_get_entity TYPE zcl_slpm_mpc=>ts_status.
 DATA systemset_get_entity TYPE zcl_slpm_mpc=>ts_system.
 DATA attachmentset_get_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA problemhistory02_get_entity TYPE zcl_slpm_mpc=>ts_problemhistoryhierarchy.
 ...
 DATA slairthistoryset_get_entity TYPE zcl_slpm_mpc=>ts_slairthistory.
 DATA slampthistoryset_get_entity TYPE zcl_slpm_mpc=>ts_slampthistory.
...
*     Call the entity set generated method
          problemhistory02_get_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
               IMPORTING er_entity          = problemhistory02_get_entity
                         es_response_context = es_response_context
          ).

        IF problemhistory02_get_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = problemhistory02_get_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA disputehistoryse_get_entityset TYPE zcl_slpm_mpc=>tt_disputehistory.
 DATA problemflowstati_get_entityset TYPE zcl_slpm_mpc=>tt_problemflowstatistics.
 DATA textset_get_entityset TYPE zcl_slpm_mpc=>tt_text.
 DATA frontendconstant_get_entityset TYPE zcl_slpm_mpc=>tt_frontendconstants.
 DATA supportteamset_get_entityset TYPE zcl_slpm_mpc=>tt_supportteam.
 DATA attachmentset_get_entityset TYPE zcl_slpm_mpc=>tt_attachment.
 DATA problemhistory02_get_entityset TYPE zcl_slpm_mpc=>tt_problemhistoryhierarchy.
 DATA slampthistoryset_get_entityset TYPE zcl_slpm_mpc=>tt_slampthistory.
 DATA productset_get_entityset TYPE zcl_slpm_mpc=>tt_product.
 DATA slairthistoryset_get_entityset TYPE zcl_slpm_mpc=>tt_slairthistory.
 DATA systemset_get_entityset TYPE zcl_slpm_mpc=>tt_system.
...
*-------------------------------------------------------------------------*
   WHEN 'ProblemHistoryHierarchySet'.
*     Call the entity set generated method
      problemhistory02_get_entityset(
        EXPORTING
         iv_entity_name = iv_entity_name
         iv_entity_set_name = iv_entity_set_name
         iv_source_name = iv_source_name
         ...
         io_tech_request_context = io_tech_request_context
       IMPORTING
         et_entityset = problemhistory02_get_entityset
         es_response_context = es_response_context
       ).
*     Send specific entity data to the caller interface
      copy_data_to_ref(
        EXPORTING
          is_data = problemhistory02_get_entityset
        CHANGING
          cr_data = er_entityset
      ).
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA disputehistoryse_update_entity TYPE zcl_slpm_mpc=>ts_disputehistory.
 DATA slairthistoryset_update_entity TYPE zcl_slpm_mpc=>ts_slairthistory.
 ...
 DATA problemflowstati_update_entity TYPE zcl_slpm_mpc=>ts_problemflowstatistics.
 ...
 DATA frontendconstant_update_entity TYPE zcl_slpm_mpc=>ts_frontendconstants.
 ...
 DATA supportteamset_update_entity TYPE zcl_slpm_mpc=>ts_supportteam.
 DATA slampthistoryset_update_entity TYPE zcl_slpm_mpc=>ts_slampthistory.
 DATA attachmentset_update_entity TYPE zcl_slpm_mpc=>ts_attachment.
 DATA systemset_update_entity TYPE zcl_slpm_mpc=>ts_system.
 DATA problemhistory02_update_entity TYPE zcl_slpm_mpc=>ts_problemhistoryhierarchy.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
*-------------------------------------------------------------------------*
      WHEN 'ProblemHistoryHierarchySet'.
*     Call the entity set generated method
          problemhistory02_update_entity(
               EXPORTING iv_entity_name     = iv_entity_name
                         iv_entity_set_name = iv_entity_set_name
                         iv_source_name     = iv_source_name
                         io_data_provider   = io_data_provider
                         ...
                         it_navigation_path = it_navigation_path
                         io_tech_request_context = io_tech_request_context
               IMPORTING er_entity          = problemhistory02_update_entity
          ).
       IF problemhistory02_update_entity IS NOT INITIAL.
*     Send specific entity data to the caller interface
          copy_data_to_ref(
            EXPORTING
              is_data = problemhistory02_update_entity
            CHANGING
              cr_data = er_entity
          ).
        ELSE.
...
* Unit test injection
  ...
  method PROBLEMHISTORY02_CREATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'PROBLEMHISTORY02_CREATE_ENTITY'.
  ...
  method PROBLEMHISTORY02_DELETE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'PROBLEMHISTORY02_DELETE_ENTITY'.
  ...
  method PROBLEMHISTORY02_GET_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'PROBLEMHISTORY02_GET_ENTITY'.
  ...
  method PROBLEMHISTORY02_UPDATE_ENTITY.
  RAISE EXCEPTION TYPE /iwbep/cx_mgw_not_impl_exc
    EXPORTING
      textid = /iwbep/cx_mgw_not_impl_exc=>method_not_implemented
      method = 'PROBLEMHISTORY02_UPDATE_ENTITY'.
