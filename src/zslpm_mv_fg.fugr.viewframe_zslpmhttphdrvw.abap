*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSLPMHTTPHDRVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSLPMHTTPHDRVW      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSLPMHTTPHDRVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSLPMHTTPHDRVW_EXTRACT
TOTAL = ZSLPMHTTPHDRVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSLPMHTTPHDRVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSLPMHTTPHDRVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMHTTPHDRVW_EXTRACT
TOTAL = ZSLPMHTTPHDRVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSLPMHTTPHDRVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSLPMHTTPHDRVW'
...
TOTAL = ZSLPMHTTPHDRVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSLPMHTTPHDRVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSLPMHTTPHDRVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSLPMHTTPHDRVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSLPMHTTPHDRVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMHTTPHDRVW_EXTRACT
TOTAL = ZSLPMHTTPHDRVW_TOTAL
