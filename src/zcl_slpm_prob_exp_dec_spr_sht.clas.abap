class zcl_slpm_prob_exp_dec_spr_sht definition
  public
  ...
  private section.
    ...
    data:
      ...
      mt_problems_export_summary     type zcrm_order_tt_sl_problems,
    ...
    methods:
      ...
      save_problem_attachments_on_fs
        importing
          ...
          it_attachments         type zif_slpm_prob_exp=>ty_attachments,
...
class zcl_slpm_prob_exp_dec_spr_sht implementation.
  ...
  method save_problem_exp_xlsx_to_fs.
    ...
    data: lo_excel                type ref to zcl_excel,
          ...
          ls_table_settings       type zexcel_s_table_settings,
          cl_writer               type ref to zif_excel_writer,
          lt_problem_data_export  type zcrm_order_tt_sl_problems,
          lt_problem_texts_export type zif_slpm_prob_exp=>ty_texts,
          lt_field_catalog        type zexcel_t_fieldcatalog,
          lt_problem_history      type zif_slpm_prob_exp=>ty_history.
