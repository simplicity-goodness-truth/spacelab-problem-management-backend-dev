class zcl_crm_categorization_schema definition
  public
  final
  create public .

  public section.
    interfaces zif_crm_categorization_schema .
...
class zcl_crm_categorization_schema implementation.
  ...
  method set_hierarchy.
    ...
    data:
      ...
      ls_cat_schema type  zcrm_ts_cat_schema_hierarchy.
  ...
  method zif_crm_categorization_schema~get_hierarchy.

    rt_hierarchy = me->mt_hierarchy.

  endmethod.

  method zif_crm_categorization_schema~get_asp_label.
  ...
  method zif_crm_categorization_schema~get_hierarchy_cat_label.
