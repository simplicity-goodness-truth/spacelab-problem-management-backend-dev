  ...
  method get_email_addresses.
    ...
    case ip_process_role.
      ...
      when 'REQUESTER'.
        ...
        lo_bp_address_book = new zcl_bp_master_data( ms_problem_new_state-requestorbusinesspartner ).
      ...
      when 'PROCESSOR'.
        ...
        lo_bp_address_book = new zcl_bp_master_data( ms_problem_new_state-processorbusinesspartner ).
        lv_email_address = lo_bp_address_book->get_email_address(  ).
...
*
*    lo_slpm_product = new zcl_slpm_product( ms_problem_new_state-productguid ).
*
