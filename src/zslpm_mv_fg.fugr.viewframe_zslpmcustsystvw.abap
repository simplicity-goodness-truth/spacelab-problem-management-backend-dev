*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSLPMCUSTSYSTVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSLPMCUSTSYSTVW     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSLPMCUSTSYSTVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSLPMCUSTSYSTVW_EXTRACT
TOTAL = ZSLPMCUSTSYSTVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSLPMCUSTSYSTVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSLPMCUSTSYSTVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMCUSTSYSTVW_EXTRACT
TOTAL = ZSLPMCUSTSYSTVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSLPMCUSTSYSTVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSLPMCUSTSYSTVW'
...
TOTAL = ZSLPMCUSTSYSTVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSLPMCUSTSYSTVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSLPMCUSTSYSTVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSLPMCUSTSYSTVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSLPMCUSTSYSTVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMCUSTSYSTVW_EXTRACT
TOTAL = ZSLPMCUSTSYSTVW_TOTAL
