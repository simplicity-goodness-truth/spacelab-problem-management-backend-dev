interface zif_slpm_prob_exp
  ...
  types:
    ...
    ty_history     type table of zslpm_ts_pr_his_hry with non-unique default key.

  types: begin of ty_problem,

           data        type zcrm_order_ts_sl_problem,
           texts       type ty_texts,
  ...
  methods:
    ...
    export_problems
      importing
        it_problems_export type zif_slpm_prob_exp=>ty_problems optional
      returning
