class zcl_slpm_products_storage definition
  public
  final
  create public .
  ...
  public section.
    interfaces:
      zif_slpm_products_storage.

  protected section.
  private section.
endclass.

class zcl_slpm_products_storage implementation.
  ...
  method zif_slpm_products_storage~get_all_slpm_products.
    ...
    data:
      ls_slpm_product type zslpm_ts_product,
      lt_products     type table of ty_product_and_cust.

    select productid customerbusinesspartner
        from zslpm_cust_prod into corresponding fields of table lt_products.
