class zcl_serv_profile definition
  public
  final
  create public .
...
class zcl_serv_profile implementation.
  ...
  method get_date_day_name.
    ...
    lv_day_of_week_name = mt_idd07v[ domvalue_l = lv_day_of_week_number ]-ddtext.
  ...
  method set_added_hrs_array_from_sec.
    ...
    elseif lv_added_full_days > 1.
      ...
      data(lv_added_minutes) = ( mv_added_seconds_total - ( lv_added_hours * 3600 ) ) div 60.
      data(lv_added_seconds) = mv_added_seconds_total - ( ( lv_added_hours * 3600 ) + ( lv_added_minutes * 60 ) ).
  ...
  method set_list_of_periods.
    ...
    loop at ms_scrule_exp-tab_w into data(wa_tab_w).
      ...
      assign component ip_from_field_name of structure wa_tab_w to <lv_from>.
      assign component ip_to_field_name of structure wa_tab_w to <lv_to>.
      assign component me->get_date_day_name( ip_date ) of structure wa_tab_w to <lv_weekday_active>.
  ...
  method zif_serv_profile~add_hours_to_date.
  ...
  method zif_serv_profile~add_seconds_to_date.
  ...
  method zif_serv_profile~is_now_an_availability_time.
