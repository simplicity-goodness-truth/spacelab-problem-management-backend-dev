*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSLPMSTATEMAILVW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSLPMSTATEMAILVW    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSLPMSTATEMAILVW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSLPMSTATEMAILVW_EXTRACT
TOTAL = ZSLPMSTATEMAILVW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSLPMSTATEMAILVW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSLPMSTATEMAILVW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMSTATEMAILVW_EXTRACT
TOTAL = ZSLPMSTATEMAILVW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSLPMSTATEMAILVW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSLPMSTATEMAILVW'
...
TOTAL = ZSLPMSTATEMAILVW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSLPMSTATEMAILVW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSLPMSTATEMAILVW-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSLPMSTATEMAILVW'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSLPMSTATEMAILVW-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSLPMSTATEMAILVW_EXTRACT
TOTAL = ZSLPMSTATEMAILVW_TOTAL
