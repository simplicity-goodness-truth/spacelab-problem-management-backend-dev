interface zif_custom_crm_order_read
  ...
  methods get_custom_fields_by_guid
    importing
      ip_guid   type crmt_object_guid
    exporting
  ...
  methods get_attachments_list_by_guid
    importing
      ip_guid                          type crmt_object_guid
    exporting
  ...
  methods get_attachment_by_keys
    importing
      ip_guid              type crmt_object_guid
      ip_loio              type string
      ip_phio              type string
  ...
  methods get_attachment_content_by_keys
    importing
      ip_guid              type crmt_object_guid
      ip_loio              type string
      ip_phio              type string
