class zcl_crm_order_auto_stat_setter definition
  public
  final
  create public .
  ...
  public section.
    ...
    interfaces zif_crm_order_auto_stat_setter .
  ...
  private section.
    ...
    data:
      mt_crmo_auto_stat_settings type table of zcrmo_auto_stat,
    ...
    methods:
      ...
      update_order
        importing
          ...
          io_custom_crm_order_init type ref to zif_custom_crm_order_init
          ip_tdid                  type tdid
...
class zcl_crm_order_auto_stat_setter implementation.

  method zif_crm_order_auto_stat_setter~process_orders_status_setting.
  ...
  method is_time_to_set_status.
    ...
    lv_seconds_since_last_status = zcl_assistant_utilities=>calc_duration_btw_timestamps(
        exporting
  ...
  method get_compiled_text.
    ...
    data: lo_standard_text    type ref to zif_standard_text,
          lt_variables_values type zst_text_tt_variables_values.
  ...
  method update_zslp_order.

    data:
      lo_slpm_data_provider type ref to zif_slpm_data_manager,
      ls_slpm_problem_in    type zcrm_order_ts_sl_problem,
      ls_slpm_problem_out   type zcrm_order_ts_sl_problem.
  ...
  method update_regular_order.
    ...
    data:
      lo_custom_crm_order_update type ref to zif_custom_crm_order_update,
      ls_payload                 type zcrm_order_ts,
