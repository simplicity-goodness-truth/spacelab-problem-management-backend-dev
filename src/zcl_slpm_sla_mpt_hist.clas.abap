class zcl_slpm_sla_mpt_hist definition
  public
  final
  create public .
...
class zcl_slpm_sla_mpt_hist implementation.

  method zif_slpm_sla_hist~is_there_pending_shift.

    data: lv_last_out_stat_for_mpt_hist type char5,
          lt_statuses_for_mpt_recalc    type zslpm_tt_status_pairs.
    ...
    select  statusout
      ...
      try.
          ...
          lt_statuses_for_mpt_recalc = new zcl_slpm_mpt_recalc_statuses( )->zif_slpm_status_pairs~get_all_status_pairs( ).
