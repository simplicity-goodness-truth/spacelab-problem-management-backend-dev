class zcl_crm_service_product definition
  public
  inheriting from zcl_crm_product
  create public .

  public section.
    interfaces zif_crm_service_product.
...
class zcl_crm_service_product implementation.
  ...
  method set_response_profile.
    ...
    ls_product-product_guid = me->zif_crm_product~get_guid( ).
  ...
  method zif_crm_service_product~get_resp_profile_table.
  ...
  method zif_crm_service_product~get_resp_profile_prio_count.
  ...
  method zif_crm_service_product~get_resp_profile_prio.
