interface zif_messenger
  ...
  methods: set_message_body
    ...
    set_message_sender
      importing
        ip_message_sender type zmessenger_address,

    set_message_recepients
      importing
        it_message_recepients type zmessenger_tt_addresses,

    set_message_attachments
      importing
        it_message_attachments type zmessenger_tt_attachments.
